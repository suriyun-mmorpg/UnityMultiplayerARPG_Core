...
namespace MultiplayerARPG
{
    public partial class BasePlayerCharacterEntity
    {
        ...
        public override void OnSetup()
        {
            ...
            RegisterNetFunction<short>(ServerUseItem);
            RegisterNetFunction<short, bool>(ServerUseSkillItem);
            RegisterNetFunction<short, bool, Vector3>(ServerUseSkillItemWithAimPosition);
            RegisterNetFunction<short, short>(ServerSwapOrMergeItem);
            RegisterNetFunction<int>(NetFuncAddAttribute);
            RegisterNetFunction<int>(ServerAddSkill);
            RegisterNetFunction<int>(ServerAddGuildSkill);
            RegisterNetFunction<int>(ServerUseGuildSkill);
            RegisterNetFunction(ServerRespawn);
            RegisterNetFunction<string, HotkeyType, string>(ServerAssignHotkey);
            RegisterNetFunction<PackedUInt>(ServerNpcActivate);
            ...
            RegisterNetFunction<byte>(ServerSelectNpcDialogMenu);
            RegisterNetFunction<short, short>(ServerBuyNpcItem);
            RegisterNetFunction<PackedUInt>(ServerEnterWarp);
            RegisterNetFunction<short, Vector3, Quaternion, PackedUInt>(ServerBuild);
            RegisterNetFunction<PackedUInt>(ServerDestroyBuilding);
            RegisterNetFunction<short, short>(ServerSellItem);
            RegisterNetFunction<short>(ServerDismantleItem);
            RegisterNetFunction<InventoryType, short>(ServerRefineItem);
            RegisterNetFunction<InventoryType, short, int>(ServerEnhanceSocketItem);
            RegisterNetFunction<InventoryType, short>(ServerRepairItem);
            RegisterNetFunction<PackedUInt>(ServerSendDealingRequest);
            RegisterNetFunction<PackedUInt>(NetFuncReceiveDealingRequest);
            RegisterNetFunction(ServerAcceptDealingRequest);
            RegisterNetFunction(ServerDeclineDealingRequest);
            RegisterNetFunction<PackedUInt>(NetFuncAcceptedDealingRequest);
            RegisterNetFunction<short, short>(ServerSetDealingItem);
            RegisterNetFunction<int>(ServerSetDealingGold);
            RegisterNetFunction(ServerLockDealing);
            RegisterNetFunction(ServerConfirmDealing);
            RegisterNetFunction(ServerCancelDealing);
            ...
            RegisterNetFunction<bool, bool>(ServerCreateParty);
            RegisterNetFunction<string>(ServerChangePartyLeader);
            RegisterNetFunction<bool, bool>(ServerPartySetting);
            RegisterNetFunction<PackedUInt>(ServerSendPartyInvitation);
            RegisterNetFunction<PackedUInt>(NetFuncReceivePartyInvitation);
            RegisterNetFunction(ServerAcceptPartyInvitation);
            RegisterNetFunction(ServerDeclinePartyInvitation);
            RegisterNetFunction<string>(ServerKickFromParty);
            RegisterNetFunction(ServerLeaveParty);
            RegisterNetFunction<string>(ServerCreateGuild);
            RegisterNetFunction<string>(ServerChangeGuildLeader);
            RegisterNetFunction<string>(ServerSetGuildMessage);
            RegisterNetFunction<byte, string, bool, bool, byte>(ServerSetGuildRole);
            RegisterNetFunction<string, byte>(ServerSetGuildMemberRole);
            RegisterNetFunction<PackedUInt>(ServerSendGuildInvitation);
            RegisterNetFunction<PackedUInt>(NetFuncReceiveGuildInvitation);
            RegisterNetFunction(ServerAcceptGuildInvitation);
            RegisterNetFunction(ServerDeclineGuildInvitation);
            RegisterNetFunction<string>(ServerKickFromGuild);
            RegisterNetFunction(ServerLeaveGuild);
            RegisterNetFunction<StorageType, uint, short, short>(NetFuncShowStorage);
            RegisterNetFunction<short, short, short>(ServerMoveItemToStorage);
            RegisterNetFunction<short, short, short>(ServerMoveItemFromStorage);
            RegisterNetFunction<short, short>(ServerSwapOrMergeStorageItem);
            RegisterNetFunction<int>(ServerDepositGold);
            RegisterNetFunction<int>(ServerWithdrawGold);
            RegisterNetFunction<int>(ServerDepositGuildGold);
            RegisterNetFunction<int>(ServerWithdrawGuildGold);
            RegisterNetFunction<PackedUInt, string>(ServerOpenStorage);
            RegisterNetFunction(ServerCloseStorage);
            RegisterNetFunction<PackedUInt, string>(ServerOpenDoor);
            RegisterNetFunction<PackedUInt>(ServerCloseDoor);
            RegisterNetFunction<PackedUInt>(ServerTurnOnCampFire);
            RegisterNetFunction<PackedUInt>(ServerTurnOffCampFire);
            RegisterNetFunction<PackedUInt, int>(ServerCraftItemByWorkbench);
            RegisterNetFunction<string>(ServerFindCharacters);
            RegisterNetFunction<string>(ServerAddFriend);
            RegisterNetFunction<string>(ServerRemoveFriend);
            RegisterNetFunction(ServerGetFriends);
            RegisterNetFunction<PackedUInt, string>(ServerSetBuildingPassword);
            RegisterNetFunction<PackedUInt>(ServerLockBuilding);
            RegisterNetFunction<PackedUInt>(ServerUnlockBuilding);
        }
