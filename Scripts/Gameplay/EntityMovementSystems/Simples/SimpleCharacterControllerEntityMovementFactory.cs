...
{
    public class SimpleCharacterControllerEntityMovementFactory : IEntityMovementFactory
    {
        public string Name => "Simple Character Controller Entity Movement";

        public DimensionType DimensionType => DimensionType.Dimension3D;

        public SimpleCharacterControllerEntityMovementFactory()
        {
