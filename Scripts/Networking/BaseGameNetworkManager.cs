    ...
    public abstract partial class BaseGameNetworkManager : LiteNetLibGameManager
    {
        ...
        protected override void RegisterMessages()
        {
            ...
            if (ServerGuildMessageHandlers != null)
            {
                ...
                RegisterRequestToServer<RequestChangeGuildOptionIdMessage, ResponseChangeGuildOptionIdMessage>(GameNetworkingConsts.ChangeGuildOptionId1, ServerGuildMessageHandlers.HandleRequestChangeGuildOptionId1);
                RegisterRequestToServer<RequestChangeGuildOptionIdMessage, ResponseChangeGuildOptionIdMessage>(GameNetworkingConsts.ChangeGuildOptionId2, ServerGuildMessageHandlers.HandleRequestChangeGuildOptionId2);
                RegisterRequestToServer<RequestChangeGuildOptionIdMessage, ResponseChangeGuildOptionIdMessage>(GameNetworkingConsts.ChangeGuildOptionId3, ServerGuildMessageHandlers.HandleRequestChangeGuildOptionId3);
                RegisterRequestToServer<RequestChangeGuildOptionIdMessage, ResponseChangeGuildOptionIdMessage>(GameNetworkingConsts.ChangeGuildOptionId4, ServerGuildMessageHandlers.HandleRequestChangeGuildOptionId4);
                RegisterRequestToServer<RequestChangeGuildOptionIdMessage, ResponseChangeGuildOptionIdMessage>(GameNetworkingConsts.ChangeGuildOptionId5, ServerGuildMessageHandlers.HandleRequestChangeGuildOptionId5);
