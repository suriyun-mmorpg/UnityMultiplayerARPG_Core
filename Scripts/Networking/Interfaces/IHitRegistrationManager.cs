...
namespace MultiplayerARPG
{
    public partial interface IHitRegistrationManager
    {
        ...
        Dictionary<DamageElement, MinMaxFloat> IncreasePreparedDamageAmounts(BaseGameEntity attacker, int randomSeed, Dictionary<DamageElement, MinMaxFloat> increaseDamageAmounts);
