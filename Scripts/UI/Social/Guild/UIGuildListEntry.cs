...
namespace MultiplayerARPG
{
    public class UIGuildListEntry : UISelectionEntry<GuildListEntry>
    {
        ...
        public UILocaleKeySetting formatKeyLeaderName = new UILocaleKeySetting(UIFormatKeys.UI_FORMAT_SIMPLE);
        ...
        protected override void UpdateData()
        {
            ...
            if (textLeaderName != null)
            {
                textLeaderName.text = string.Format(
                    ...
                    Data == null ? LanguageManager.GetUnknowTitle() : Data.LeaderName);
            }
