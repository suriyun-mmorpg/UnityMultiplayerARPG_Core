...
namespace MultiplayerARPG
{
    public partial class UINpcSellItem : UISelectionEntry<NpcSellItem>
    {
        ...
        public void OnClickBuy()
        {
            ...
            if (item.MaxStack == 1)
            {
                GameInstance.PlayingCharacterEntity.NpcAction.CallServerBuyNpcItem((short)indexOfData, 1);
            }
            else
            {
        ...
        {
            GameInstance.PlayingCharacterEntity.NpcAction.CallServerBuyNpcItem((short)indexOfData, (short)amount);
        }
    }
}
