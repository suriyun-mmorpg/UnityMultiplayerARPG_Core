...
namespace MultiplayerARPG
{
    ...
    /// </summary>
    public class Scrollbar001 : Scrollbar
    {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(Scrollbar001), true)]
    [CanEditMultipleObjects]
    public class Scrollbar001Editor : UnityEditor.UI.ScrollbarEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Scrollbar001 target = this.target as Scrollbar001;
