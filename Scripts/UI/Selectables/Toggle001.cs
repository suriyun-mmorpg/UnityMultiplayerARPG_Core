...
#if UNITY_EDITOR
    [CustomEditor(typeof(Toggle001), true)]
    [CanEditMultipleObjects]
    public class Toggle001Editor : UnityEditor.UI.ToggleEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Toggle001 target = this.target as Toggle001;
