...
#if UNITY_EDITOR
    [CustomEditor(typeof(Button001), true)]
    [CanEditMultipleObjects]
    public class Button001Editor : UnityEditor.UI.ButtonEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Button001 target = this.target as Button001;
