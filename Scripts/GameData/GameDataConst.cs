...
{
    public const string CHARACTER_BUFF_PREFIX = "<Buff>_";
    public const string CHARACTER_DEBUFF_PREFIX = "<Debuff>_";
    ...
    public const string UNKNOW_ARMOR_TYPE_TITLE = "Unknow Armor";
    public const string UNKNOW_WEAPON_TYPE_ID = "<UNKNOW_WEAPON>";
    public const string UNKNOW_WEAPON_TYPE_TITLE = "Unknow Weapon";
}
