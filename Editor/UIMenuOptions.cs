...
namespace UnityEditor.UI
{
    public static class UIMenuOptions
    {
        ...
        [MenuItem("GameObject/UI/Wrappers/Text Wrapper", false)]
        public static void CreateTextWrapper(MenuCommand menuCommand)
        {
            ...
            TextWrapper wrapper = go.AddComponent<TextWrapper>();
            wrapper.unityText = go.GetComponent<Text>();
        ...
        public static void CreateDropdownWrapper(MenuCommand menuCommand)
        {
            ...
            DropdownWrapper wrapper = go.AddComponent<DropdownWrapper>();
            wrapper.unityDropdown = go.GetComponent<Dropdown>();
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = TMP_DefaultControls.CreateDropdown(GetTMPStandardResources());
            DropdownWrapper wrapper = go.AddComponent<DropdownWrapper>();
        ...
        public static void CreateInputFieldWrapper(MenuCommand menuCommand)
        {
            ...
            InputFieldWrapper wrapper = go.AddComponent<InputFieldWrapper>();
            wrapper.unityInputField = go.GetComponent<InputField>();
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = TMP_DefaultControls.CreateInputField(GetTMPStandardResources());
            InputFieldWrapper wrapper = go.AddComponent<InputFieldWrapper>();
