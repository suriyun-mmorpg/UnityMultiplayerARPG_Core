...
namespace MultiplayerARPG
{
    ...
    public class SkillEditor : BaseCustomEditor
    {
        ...
        protected override void SetFieldCondition()
        {
            ...
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillType), SkillType.Active.ToString(), cacheSkill.GetMemberName(a => a.skillDamageType));
            ...
            // Normal Attack skill
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.Normal.ToString(), cacheSkill.GetMemberName(a => a.hitEffects));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.Normal.ToString(), cacheSkill.GetMemberName(a => a.damageInfo));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.Normal.ToString(), cacheSkill.GetMemberName(a => a.effectivenessAttributes));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.Normal.ToString(), cacheSkill.GetMemberName(a => a.damageAmount));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.Normal.ToString(), cacheSkill.GetMemberName(a => a.weaponDamageInflictions));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.Normal.ToString(), cacheSkill.GetMemberName(a => a.additionalDamageAmounts));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.Normal.ToString(), cacheSkill.GetMemberName(a => a.isDebuff));
            // Based On Weapon Attack skill
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.BasedOnWeapon.ToString(), cacheSkill.GetMemberName(a => a.hitEffects));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.BasedOnWeapon.ToString(), cacheSkill.GetMemberName(a => a.weaponDamageInflictions));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.BasedOnWeapon.ToString(), cacheSkill.GetMemberName(a => a.additionalDamageAmounts));
            ShowOnEnum(cacheSkill.GetMemberName(a => a.skillDamageType), SkillDamageType.BasedOnWeapon.ToString(), cacheSkill.GetMemberName(a => a.isDebuff));
            // Debuff
